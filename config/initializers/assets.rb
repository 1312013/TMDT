...
Rails.application.config.assets.precompile += %w( sd-admin-2.css )
Rails.application.config.assets.precompile += %w( sd-admin-2.min.css )
...
Rails.application.config.assets.precompile += %w( sd-admin-2.js )
Rails.application.config.assets.precompile += %w( sd-admin-2.min.js )
